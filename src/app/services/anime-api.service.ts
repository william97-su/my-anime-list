...
export class AnimeService {
  ...
  private API_URL_ID = 'https://api.jikan.moe/v4/anime/';
  ...
  getAnimeById(searchTerm: string): Observable<APIAnime> {
    return this.http.get<APIAnime>(`${this.API_URL_ID}${searchTerm}`)
  }
